...
**Public extract:** 9,544 rows · **Live catalog:** 9,542 domains
...
- `coupons.csv` — public CSV extract (9,544 rows)
- `coupons.json` — public JSON extract (9,544 rows)
...
| ----------------------- | ------------------------------------------------ |
| 9,544-row public sample | 9,542 live domains                               |
...
> Unique Domains. *Available .COUPONS One-Word Domains*. Version 2026-04-13. Public GitHub extract for the exact Unique Domains search represented by this repository.
